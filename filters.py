...
"Blue Plumage Squawkabilly","Debutante Trim Furfrou","Blue-Striped Basculin","La Reine Trim Furfrou","Diamond Trim Furfrou","Pharaoh Trim Furfrou","Orange Meteor Minior","Indigo Meteor Minior","Matron Trim Furfrou","Kabuki Trim Furfrou","Green Meteor Minior","Heart Trim Furfrou","Dandy Trim Furfrou","Blue Meteor Minior","Orange Core Minior","Indigo Core Minior","Bloodmoon Ursaluna","Spiky-eared Pichu","School Wishiwashi","Red Meteor Minior","Green Core Minior","Gulping Cramorant","Gorging Cramorant","Noice Face Eiscue","Pom-pom Oricorio","Blue Core Minior","Droopy Tatsugiri","Red Core Minior","Battle Cyclizar","Rainy Castform","Snowy Castform","Sensu Oricorio","Hangry Morpeko","Rotom Pokédex","Pa'u Oricorio","Ride Cyclizar","Squawkabilly","Brute Bonnet","Flutter Mane","Slither Wing","Sandy Shocks","Iron Jugulis","Roaring Moon","Iron Valiant","Gouging Fire","Iron Boulder","Frost Rotom","Rotom Phone","Rotom Drone","Scream Tail","Iron Treads","Iron Bundle","Iron Thorns","Iron Leaves","Raging Bolt","MissingNo.","Farfetch'd","Kangaskhan","Aerodactyl","Heat Rotom","Bouffalant","Pincurchin","Bombirdier","Great Tusk","Iron Hands","Iron Crown","Heracross","Relicanth","Pachirisu","Spiritomb","Carnivine","Fan Rotom","Mow Rotom","Alomomola","Cryogonal","Druddigon","Passimian","Pyukumuku","Cramorant","Dracozolt","Arctozolt","Dracovish","Arctovish","Iron Moth","Qwilfish","Delibird","Skarmory","Smeargle","Illumise","Lunatone","Castform","Basculin","Maractus","Sigilyph","Hawlucha","Oricorio","Oranguru","Dhelmise","Indeedee","Cyclizar","Orthworm","Shuckle","Corsola","Miltank","Sableye","Seviper","Solrock","Kecleon","Luvdisc","Heatmor","Furfrou","Dedenne","Carbink","Mimikyu","Bruxish","Falinks","Morpeko","Flamigo","Dondozo","Pinsir","Lapras","Mawile","Plusle","Spinda","Chatot","Audino","Emolga","Durant","Klefki","Comfey","Minior" ,"Komala","Drampa","Eiscue","Ditto","Minun","Absol","Rotom","Klawf","Sawk","Yellow Plumage Squawkabilly","White Plumage Squawkabilly","Yellow Meteor Minior","Violet Meteor Minior","Yellow Core Minior","Violet Core Minior","Stretchy Tatsugiri","Unown Exclamation","Star Trim Furfrou","Unown Question","Sunny Castform","Walking Wake","Stonjourner","Wash Rotom","Wishiwashi","Turtonator","Togedemaru","Tatsugiri","Zangoose","Stunfisk","Unown A","Unown B","Unown C","Unown D","Unown E","Unown G","Unown H","Unown I","Unown J","Unown K","Unown L","Unown M","Unown N","Unown O","Unown P","Unown Q","Unown R","Unown S","Unown T","Unown U","Unown V","Unown W","Unown X","Unown Y","Unown Z","Volbeat","Torkoal","Tropius","Tauros","Veluza","Unown","Throh"         ]
    ...
    "something": {
        ...
        "pokemon": [
            "Bloodmoon Ursaluna","Brute Bonnet","Flutter Mane","Iron Jugulis","Iron Valiant","Gouging Fire","Iron Boulder","Corviknight","Centiskorch","Iron Treads","Iron Bundle","Iron Thorns","Iron Leaves","Butterfree","Aerodactyl","Grimmsnarl","Copperajah","Annihilape","Great Tusk","Iron Hands","Iron Crown","Charizard","Blastoise","Ninetales","Heracross","Pachirisu","Cinderace","Coalossal","Cramorant","Hatterene","Duraludon","Iron Moth","Hydrapple","Lunatone","Basculin","Garbodor","Hawlucha","Inteleon","Orbeetle","Appletun","Alcremie","Indeedee","Koraidon","Pikachu","Persian","Machamp","Kingler","Jolteon","Flareon","Corsola","Miltank","Leafeon","Glaceon","Furfrou","Dedenne","Carbink","Mimikyu","Drednaw","Flapple","Milcery","Falinks","Morpeko","Dipplin","Gengar","Lapras","Espeon","Mawile","Plusle","Emolga","Golurk","Minior","Komala","Eiscue","Ditto","Pichu","Minun","Absol", "Galarian Zen Darmanitan","Galarian Farfetch'd","Combat Breed Tauros","Galarian Darmanitan","Blaze Breed Tauros","Hisuian Typhlosion","Galarian Zigzagoon","Hisuian Growlithe","Galarian Rapidash","Galarian Slowpoke","Hisuian Electrode","Aqua Breed Tauros","Galarian Slowking","Hisuian Lilligant","Galarian Darumaka","Galarian Stunfisk","Hisuian Decidueye","Alolan Sandshrew","Alolan Sandslash","Alolan Ninetales","Hisuian Arcanine","Galarian Slowbro","Alolan Exeggutor","Galarian Weezing","Hisuian Qwilfish","Galarian Corsola","Galarian Linoone","Hisuian Samurott","Alolan Raticate","Alolan Graveler","Galarian Ponyta","Hisuian Voltorb","Hisuian Sneasel","Galarian Yamask","Hisuian Zoroark","Hisuian Sliggoo","Hisuian Avalugg","Alolan Rattata","Alolan Diglett","Alolan Dugtrio","Alolan Persian","Alolan Geodude","Alolan Marowak","Paldean Wooper","Hisuian Goodra","Alolan Raichu","Alolan Grimer","Hisuian Zorua","Alolan Golem","Slither Wing","Sandy Shocks","Roaring Moon","Walking Wake","Scream Tail","Raging Bolt","Alolan Muk","Togedemaru","Sandaconda","Perrserker","Archaludon","Relicanth","Spiritomb","Rillaboom","Obstagoon","Venusaur","Vaporeon","Zangoose","Vivillon","Meowstic","Snorlax","Umbreon","Zoroark","Sylveon","Unown","Rotom" ,"High-speed Flight Configuration Genesect","Pirouette Meloetta","Galarian Articuno","Therian Thundurus","Galarian Moltres","Therian Tornadus","Therian Landorus","Complete Zygarde","Galarian Zapdos","Origin Giratina","Electric Arceus","Fighting Arceus","Resolute Keldeo","Neutral Xerneas","Primal Groudon","Defense Deoxys","Psychic Arceus","Mega Mewtwo X","Mega Mewtwo Y","Primal Kyogre","Mega Rayquaza","Attack Deoxys","Origin Dialga","Origin Palkia","Dragon Arceus","Flying Arceus","Ground Arceus","Poison Arceus","Hoopa Unbound","Speed Deoxys","Ghost Arceus","Grass Arceus","Steel Arceus","Water Arceus","Fairy Arceus","Black Kyurem","White Kyurem","Zygarde Cell","Zygarde Core","Mega Diancie","Mega Latias","Mega Latios","Sky Shaymin","Dark Arceus","Fire Arceus","Rock Arceus","10% Zygarde","Basculegion","Bug Arceus","Ice Arceus","Sirfetch'd","Registeel","Regigigas","Cresselia","Terrakion","Thundurus","Runerigus","Articuno","Regirock","Rayquaza","Giratina","Cobalion","Virizion","Tornadus","Reshiram","Landorus","Meloetta","Genesect","Mr. Rime","Sneasler","Overqwil","Moltres","Suicune","Groudon","Jirachi","Mesprit","Heatran","Manaphy","Darkrai","Shaymin","Victini","Xerneas","Yveltal","Zygarde","Diancie","Cursola","Zapdos","Mewtwo","Raikou","Celebi","Regice","Latias","Latios","Kyogre","Deoxys","Dialga","Palkia","Phione","Arceus","Zekrom","Kyurem","Keldeo","Entei","Lugia","Ho-Oh","Azelf","Hoopa","Uxie","Mew" ,"Gigantamax Single Strike Urshifu","Gigantamax Rapid Strike Urshifu","Rapid Strike Urshifu","Dawn Wings Necrozma","Gigantamax Melmetal","Eternamax Eternatus","Dusk Mane Necrozma","Electric Silvally","Fighting Silvally","Original Magearna","Crowned Zamazenta","Psychic Silvally","Zenith Marshadow","Dragon Silvally","Flying Silvally","Ground Silvally","Poison Silvally","Ghost Silvally","Grass Silvally","Steel Silvally","Water Silvally","Fairy Silvally","Ultra Necrozma","Crowned Zacian","Dark Silvally","Fire Silvally","Rock Silvally","Bug Silvally","Ice Silvally","Blacephalon","Type: Null","Celesteela","Volcanion","Tapu Koko","Tapu Lele","Tapu Bulu","Tapu Fini","Pheromosa","Xurkitree","Marshadow","Naganadel","Stakataka","Zamazenta","Eternatus","Silvally","Solgaleo","Nihilego","Buzzwole","Guzzlord","Necrozma","Magearna","Melmetal","Cosmoem","Kartana","Poipole","Zeraora","Urshifu","Cosmog","Lunala","Meltan","Zacian","Zarude","Kubfu" ,"Vanilla Cream Clover Sweet Alcremie","Vanilla Cream Flower Sweet Alcremie","Vanilla Cream Ribbon Sweet Alcremie","Vanilla Cream Berry Sweet Alcremie","Vanilla Cream Love Sweet Alcremie","Vanilla Cream Star Sweet Alcremie","Sprinting Build Koraidon","Hearthflame Mask Ogerpon","Cornerstone Mask Ogerpon","Wellspring Mask Ogerpon","White-Striped Basculin","Gliding Build Koraidon","Blue-Striped Basculin","Continental Vivillon","Archipelago Vivillon","Shadow Rider Calyrex","High Plain Vivillon","Drive Mode Miraidon","Glide Mode Miraidon","Sandstorm Vivillon","Poké Ball Vivillon","Low Key Toxtricity","Bloodmoon Ursaluna","Terastal Terapagos","Spiky-eared Pichu","Unown Exclamation","Icy Snow Vivillon","Gulping Cramorant","Gorging Cramorant","Ice Rider Calyrex","Elegant Vivillon","Therian Enamorus","Dada Zarude","Fezandipiti","Wishiwashi","Regieleki","Regidrago","Glastrier","Spectrier","Chien-Pao","Munkidori","Terapagos","Pecharunt","Munchlax","Enamorus","Wo-Chien","Miraidon","Calyrex","Ting-Lu","Okidogi","Ogerpon","Chi-Yu","Zorua" ,"Debutante Trim Furfrou","La Reine Trim Furfrou","Diamond Trim Furfrou","Pharaoh Trim Furfrou","Matron Trim Furfrou","Kabuki Trim Furfrou","Galarian Mr. Mime","School Wishiwashi","Noice Face Eiscue","Monsoon Vivillon","Savanna Vivillon","Pom-pom Oricorio","Amped Toxtricity","Partner Pikachu","Summer Sawsbuck","Autumn Sawsbuck","Winter Sawsbuck","Tundra Vivillon","Garden Vivillon","Modern Vivillon","Marine Vivillon","Jungle Vivillon","Unown Question","Polar Vivillon","River Vivillon","Ocean Vivillon","Fancy Vivillon","Sensu Oricorio","Hangry Morpeko","Partner Eevee","Rotom Pokédex","Sun Vivillon","Hero Palafin","Frost Rotom","Rotom Phone","Rotom Drone","Heat Rotom","Wash Rotom","Wishiwashi","Fan Rotom","Mow Rotom","Cramorant","Sinistcha","Garchomp","Basculin","Sawsbuck","Vivillon","Oricorio","Alcremie","Ursaluna","Unown A","Unown B","Unown C","Unown D","Unown E","Unown G","Unown H","Unown I","Unown J","Unown K","Unown L","Unown M","Unown N","Unown O","Unown P","Unown Q","Unown R","Unown S","Unown T","Unown U","Unown V","Unown W","Unown X","Unown Y","Unown Z","Lucario","Furfrou","Morpeko","Pyroar","Minior","Eiscue","Pichu","Unown","Rotom" ,
        ]
    },
    "1/225": {
        "name":
